...
| V04 | Fatih membership mismatch           | Any `country_code`, `city`, or `town` mismatch is excluded                                                         | Membership implementation requires the structured Fatih signals. Dedicated test confirms a wrong-town record is rejected.                                                                                                                                                               | `GeoapifyCandidateSource.cs`; `GetCandidatesAsync_RejectsWrongTown()`                                                                | **Pass** |
